gcc 4kin4_1.c -g -o 4kin4_1 -I /opt/intel/compilers_and_libraries_2016.1.150/linux/mkl/include/ -I /usr/local/Wolfram/Mathematica/10.3/SystemFiles/IncludeFiles/C/ -L/opt/intel/compilers_and_libraries_2016.1.150/linux/mkl/lib/intel64_lin/ -lmkl_intel_lp64 -lmkl_intel_thread -lmkl_core -lm -lpthread -L /opt/intel/compilers_and_libraries_2016.1.150/linux/compiler/lib/intel64_lin/ -liomp5 -O3 -march=native -fopenmp
...
#one run:
./4kin4_1 path/hamiltonian.dat Efermi k1 k2 k3

#reaction path

for ((i=n;i<N;i++)); do
./4kin4_1 path/hamiltonian${i}_hr.dat Efermi k1 k2 k3
done
#time
